...
class HomeFragment : Fragment() {
    ...
    private fun inputDummyMovies(){
        ...
        movieDB.MovieDao().insert((Movie("사이버 지옥: n번방을 무너뜨려라", R.drawable.movie03, true, "n번방 성착취물 제작 및 유포 사건을 소재로 한 넷플릭스 오리지널 다큐멘터리")))
        movieDB.MovieDao().insert((Movie("기생충", R.drawable.movie04, true, "\"이 영화는 악인이 없으면서도 비극이고, 광대가 없는데도 희극이다.\n" + "2019년에 개봉된 봉준호 감독의 7번째 장편 영화. 상류층과 하류층. 두 가족의 만남을 다룬 대한민국의 블랙 코미디 가족 드라마 영화다.")))
        ...
        movieDB.MovieDao().insert((Movie("D.P.", R.drawable.movie07, true, "탈영병들을 잡는 군무 이탈 체포조(D.P.) 준호와 호열이 다양한 사연을 가진 이들을 쫓으며 미처 알지 못했던 현실을 마주하는 이야기")))
        ...
        movieDB.MovieDao().insert((Movie("기묘한이야기 3", R.drawable.movie10, true, "1985년, 인디애나주 호킨스. 여름이 후끈 달아오른다. 방학이 시작되고, 동네에 새 쇼핑몰이 개장했다. 호킨스 아이들은 성인이 되는 문턱에 서 있다. 풋사랑이 싹트고 친구들 사이의 우정은 꼬이기 시작한다. 이제 아이들은 우정도 지키면서 성장할 방법을 찾아야만 한다. 한편, 또다시 위험이 다가온다. 오래된 적과 새로 등장한 적의 위협에 맞서며, 일레븐과 친구들은 다시금 되새긴다. 악은 결코 끝나지 않고 진화한다는 것을. 이제 생존을 위해 다시 한번 뭉쳐야 할 때다. 우정은 공포보다 강하다는 걸 마음에 새기며.")))
